...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    // '9bb08a7cd49548b09043854b2c7c946c,en:ec276c961afb4d73a9b7eafb99c66365',
    '9bb08a7cd49548b09043854b2c7c946c',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '慕雨', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.axin.work', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '慕雨, 博客', // 网站关键词 英文逗号隔开
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.axin.work/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  COMMENT_TWIKOO_COUNT_ENABLE:
    process.env.NEXT_PUBLIC_COMMENT_TWIKOO_COUNT_ENABLE || false, // 博客列表是否显示评论数
  COMMENT_TWIKOO_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL ||
    'https://cdn.staticfile.org/twikoo/1.6.32/twikoo.all.min.js',// twikoo客户端cdn
    // 'https://cdn.staticfile.org/twikoo/1.6.17/twikoo.min.js',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '慕雨 Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
